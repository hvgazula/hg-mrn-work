...
def multishot_exact(X1, site_01_y1, X2, site_02_y1, X3, site_03_y1, X4,
    ...
    for voxel in prange(size_y):
        ...
        avg_beta_vector = (
            np.linalg.inv(cov1 + cov2 + cov3 + cov4 + cov5 + cov6 + cov7) @ Xy1
        ) + (
            np.linalg.inv(cov1 + cov2 + cov3 + cov4 + cov5 + cov6 + cov7) @ Xy2
        ) + (
            np.linalg.inv(cov1 + cov2 + cov3 + cov4 + cov5 + cov6 + cov7) @ Xy3
        ) + (
            np.linalg.inv(cov1 + cov2 + cov3 + cov4 + cov5 + cov6 + cov7) @ Xy4
        ) + (np.linalg.inv(cov1 + cov2 + cov3 + cov4 + cov5 + cov6 + cov7)
             @ Xy5) + (
                 np.linalg.inv(cov1 + cov2 + cov3 + cov4 + cov5 + cov6 + cov7)
                 @ Xy6) + (np.linalg.inv(
                     cov1 + cov2 + cov3 + cov4 + cov5 + cov6 + cov7) @ Xy7)
...
results = shelve.open(os.path.join(folder_name, 'multishotexact'))
