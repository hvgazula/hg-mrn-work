...
obj1 = fitgmdist(site1_X, 3, 'RegularizationValue', 1e-1, 'Options', options);
obj2 = fitgmdist(site2_X, 3, 'RegularizationValue', 1e-1, 'Options', options);
obj3 = fitgmdist(site3_X, 3, 'RegularizationValue', 1e-1, 'Options', options);
